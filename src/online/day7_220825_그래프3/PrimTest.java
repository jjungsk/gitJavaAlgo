...
//			System.out.println(adjList[from].vertex + " : " + adjList[from].weight + " : " + adjList[from].next);
//			System.out.println(adjList[to].vertex + " : " + adjList[to].weight + " : " + adjList[to].next);
//			System.out.println("----------------");
		}
		...
		for (int c = 0; c < V; c++) { // V개의 정점 처리하면 끝
			...
			// step 2. 신장트리에 추가
			visited[minVertex] = true; // visited는 한번만 처리
			result += min;
			
			System.out.print(minVertex + " : " + min);
			System.out.println();
